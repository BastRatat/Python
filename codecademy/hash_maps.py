class HashMap:
    def __init__(self, array_size):
        ...
        self.array = [None for value in range(self.array_size)]
    
    # A hashing function takes a key and returns an index into the underlying array.
    def hash(self, key, count_collisions=0):
        key_bites = key.encode()
        # encode() is a method that converts a string into its corresponding bytes with the numerical representation of each character in the string.
